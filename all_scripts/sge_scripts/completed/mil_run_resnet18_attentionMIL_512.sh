...
#$ -j y
#$ -l gpu=true
#$ -N mil_attentionMIL_resnet18_32epochs_cv5
echo "Running on host: $(hostname)"
echo "Starting at: $(date)"
cd secrier_lab/persistence/
source /home/xuelonan/secrier_lab/python3.8.5-biomedai.source
source /share/apps/source_files/cuda/cuda-11.8.source
python3 HistoMIL/Notebooks/mil_run.py --exp-name 'attentionMIL_resnet18_32epoch_512' \
                                      --project-name 'g0-arrest-resnet18-512-attentionMIL_cv5' \
                                      ...
                                      --split-ratio 0.9 0.1 --step-size 512 \
