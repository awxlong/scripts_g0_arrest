...
#$ -N mil_inference_ensemble_uni_ablation
echo "Running on host: $(hostname)"
echo "Starting at: $(date)"
cd secrier_lab/persistence/
source /home/xuelonan/secrier_lab/python3.8.5-biomedai.source
source /share/apps/source_files/cuda/cuda-11.8.source
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-transmil-multimodal-uni' \
                                            ...
                                            --label-dict "{0:0,1:1}" \
                                            --ckpt-filenames 'mil_transmil_uni_multimodal_32epochs_cv5cv=0_epoch=11-auroc_val=0.75' 'mil_transmil_uni_multimodal_32epochs_cv5cv=1_epoch=13-auroc_val=0.80' 'mil_transmil_uni_multimodal_32epochs_cv5cv=2_epoch=07-auroc_val=0.77' 'mil_transmil_uni_multimodal_32epochs_cv5cv=3_epoch=17-auroc_val=0.75' 'mil_transmil_uni_multimodal_32epochs_cv5cv=4_epoch=16-auroc_val=0.76'


python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-transmil-regression-uni' \
                                            --project-name 'g0-arrest-inference-uni-binary' \
                                            --wandb-entity-name 'anwangxuelong' --localcohort-name 'COAD' \
