...
#$ -j y
#$ -l gpu=true
#$ -N mil_graphtransformer_uni_42epochs_cv5_multisteplr
echo "Running on host: $(hostname)"
echo "Starting at: $(date)"
cd secrier_lab/persistence/
source /home/xuelonan/secrier_lab/python3.8.5-biomedai.source
source /share/apps/source_files/cuda/cuda-11.8.source
python3 HistoMIL/Notebooks/mil_run.py --exp-name 'mil_graphtransformer_uni_42epochs_cv5_multisteplr' \
                                      --project-name 'g0-arrest-uni-cv5-graph-transformer' \
